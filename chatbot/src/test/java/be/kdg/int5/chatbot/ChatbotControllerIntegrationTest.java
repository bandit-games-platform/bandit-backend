...
import be.kdg.int5.chatbot.adapters.out.conversation.ConversationJpaRepository;
import be.kdg.int5.chatbot.adapters.out.conversation.GameConversationJpaEntity;
